...
For live routed work and current architecture/runtime state, use `docs/CURRENT_ROUTING.md` for the short route, `docs/CURRENT_SYSTEM_STATE.md` for tracked current repo state, `docs/SESSION_HANDOFF.md` for the active packet plus next truthful slice, and `docs/ARCHITECTURE.md` together with `config/architecture_large_file_inventory_v1.json` for the current architecture map and reopened oversized-file backlog.
...
architecture gate. See `docs/ARCHITECTURE_GOVERNANCE_REBASELINE_MILESTONE_PLAN.md` and
`config/architecture_large_file_inventory_v1.json` for the current governance rebaseline and live
oversized-file backlog, `docs/OVERALL_ARCHITECTURE_REFACTOR_MILESTONE_PLAN.md` for the resolved
umbrella history, and `docs/UNDER_800_HOTSPOT_REDUCTION_MILESTONE_PLAN.md` for the historical
zero-oversized closeout record.
