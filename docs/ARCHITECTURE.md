...
The first-class eval/trace contract is a meta-eval owner in the eval layer. It
does not score domain behavior directly; it declares canonical eval/trace
objects, enum families, artifact-family link checks, deterministic scorer
requirements, export preconditions, and ratchet-scope rules that future
inventory, store, export, and gate-integration milestones must obey.
