...
| Compliance | Produce citation-bearing compliance findings, matrices, finding graphs, coverage, and gold evals. | `compliance_review.py`, `compliance_inputs.py`, `compliance_validation.py`, `compliance_outputs.py`, `compliance_coverage.py`, `compliance_gold_eval.py` |
