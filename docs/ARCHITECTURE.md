...
| Evidence and claims | Build graph and source-claim layers used by later rule and review gates. | `evidence_graph.py`, `claim_extraction.py`, `claim_extraction_eval.py`, `claim_extraction_graph.py`, `claim_extraction_validation.py`, `rule_claim_binding.py` |
