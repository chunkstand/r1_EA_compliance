...
| Applicability | Build package facts, assemble authority candidate contracts, retrieve/trace authority evidence, decide applicability, validate and adjudicate decisions, and generate applicability rule packs. | `package_fact_graph.py`, `applicability.py`, `applicability_authority_family_templates.py`, `applicability_candidate_assembly.py`, `applicability_contract_support.py`, `applicability_decisions.py`, `applicability_retrieval.py`, `applicability_rule_pack.py`, `applicability_validation.py` |
