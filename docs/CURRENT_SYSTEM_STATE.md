...
- live generated-artifact state:
  the ignored local `source_library` applicability eval result has not been
  regenerated by this slice. The existing file is still the older 9-case
  `source-set-ba8d0feae79501b8` summary and lacks the new contract identity,
  blocking metric group fields, and `applicability_failure_intake_cases.json`.
  Any live West Reservoir/f70 readiness claim must first rerun
  `applicability-eval --source-set-id source-set-f70ea11e04ae3d53`, then rerun
