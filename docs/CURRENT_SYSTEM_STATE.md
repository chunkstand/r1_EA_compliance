...
- packet outcome:
  ...
  shared tribal-overlap current-source additions, and the governed wildlife
...
- live replay truth:
  ...
  and `618` admitted `active_review_corpus` rows. Because the wildlife
