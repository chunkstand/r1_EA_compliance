...
stack uses only stage labels, and page two consolidates intake tracing, work package rendering,
reviewer adjudication, and EA assembly handoff into one system-capability view.
