...
layout and verifies the PDF stays at 8 pages or fewer; the current styled PDF renders as 4 pages.
It is grounded in the current Project SOW package docs, `config/project_sow_resource_scopes_v1.json`,
the East Crazies intake fixture, and a temporary East Crazies package smoke run under
