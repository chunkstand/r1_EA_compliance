...
The latest queue follow-on now also narrows `FINAL-Q-LOLO-001` into
`docs/LOLO_PINYON_FILE_SET_BLOCKER_MILESTONE_PLAN.md` as an explicit mixed
...
- `README.md`, `AGENTS.md`, and the current workbook contract now define
  `Document_Register_Master=647` as the active load-bearing table while
