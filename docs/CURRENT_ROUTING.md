...
- Latest resolved architecture slice: catalog fixture-backed test split after the phase direct-eval forest-plan source split; inventory and route-doc caps are current.
