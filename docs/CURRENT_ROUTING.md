...
- Latest resolved architecture slice: phase direct-eval forest-plan source split after the phase direct-eval source-set contract test split; inventory and route-doc caps are current.
