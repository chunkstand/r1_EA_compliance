...
- Latest resolved architecture slice: eval trace store SQLite source-owner split after source-register proving I/O split; inventory and route-doc caps are current.
