...
- Latest resolved forest-plan component inventory slice: all-R1 legacy direction and management-area inventory closeout; temp f70 manifest replay passed for 10/10 profiles with `component_count=5894`, `standard_count=1888`, zero duplicate IDs, and zero source-accuracy failures.
...
- Forest Plan inventory route: active forest-plan component builds must use the manifest/source-set inventory path; management areas are first-class inventory scope, not profile stuffing or forest-specific handwritten rules.
