...
- Latest resolved architecture slice: forest-plan resolver scope readiness test-owner split after applicability authority-family template split; inventory and route-doc caps are current.
