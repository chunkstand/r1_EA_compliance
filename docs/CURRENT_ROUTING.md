...
- Latest resolved architecture slice: applicability authority-family template test-owner split after extraction-fidelity source-owner reduction; inventory and route-doc caps are current.
