...
- Latest resolved architecture slice: claim extraction eval support source-owner split after forest-plan resolver scope readiness test split; inventory and route-doc caps are current.
