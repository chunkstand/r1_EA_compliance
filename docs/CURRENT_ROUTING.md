...
- Latest resolved architecture slice: forest-plan profile context test split after decision-support input validation source split; inventory and route-doc caps are current.
