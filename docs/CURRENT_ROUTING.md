...
- Latest resolved architecture slice: source-register proving I/O source-owner split after CLI eval parser test split; inventory and route-doc caps are current.
