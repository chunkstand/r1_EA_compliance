...
- Latest resolved architecture slice: phase direct-eval source-set contract test split after the extraction accuracy fixture-backed test split; inventory and route-doc caps are current.
