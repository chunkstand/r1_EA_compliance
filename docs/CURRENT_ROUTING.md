...
- Latest resolved architecture slice: promotion-suite full-canonical runtime test split after eval trace store SQLite split; inventory and route-doc caps are current.
