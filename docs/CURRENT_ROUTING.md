...
- Latest resolved architecture slice: extraction accuracy fixture-backed test split after the rule-claim binding eval support source split; inventory and route-doc caps are current.
