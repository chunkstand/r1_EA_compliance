...
- Latest resolved architecture slice: CLI eval parser test-owner split after claim extraction eval support source split; inventory and route-doc caps are current.
