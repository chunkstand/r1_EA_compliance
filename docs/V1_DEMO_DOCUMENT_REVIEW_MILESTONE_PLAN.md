...
- The pre-applicability promoted compliance review was reviewer-ready with `44` findings, `40` pass
  ...
  that output with `34` generated compliance findings, all `34` pass, all `26` baseline source
  records evaluated through the generated applicability rule pack, `147` generated-pack rule-claim
