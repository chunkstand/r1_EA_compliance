...
class ComplianceReviewEvalTests(unittest.TestCase):
    def test_compliance_review_eval_scores_package_fixtures(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(cases["unit-all-pass"]["authority_explanation_artifact_present"])
            self.assertTrue(cases["unit-all-pass"]["authority_path_classification_supported"])
            self.assertTrue(cases["unit-all-pass"]["authority_trace_coverage_supported"])
