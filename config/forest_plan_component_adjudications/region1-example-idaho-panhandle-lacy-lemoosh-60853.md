...
- No item is classified as a `true_ea_omission`; this replay closes the component worklist as system classification/linking cleanup while source-set FEIS readiness remains a separate blocker.
...
- Rationale: The Lacy Lemoosh forest-plan consistency worksheet contains a non-not-applicable response for FW-
  STD-VEG-01; the current queue is missing or under-linking package evidence, not identifying a real
  EA omission.
...
### FOR-021-FW-STD-WL-01

- Disposition: `applicability_false_positive`
- Source type: `lacy_lemoosh_package_scope_review`
- Rationale: The Lacy Lemoosh forest-plan consistency worksheet marks FW-STD-WL-01 not applicable for this
  project scope, so the current reviewer queue overstates component applicability.

### FOR-021-FW-STD-AR-01

- Disposition: `applicability_false_positive`
- Source type: `lacy_lemoosh_package_scope_review`
- Rationale: The Lacy Lemoosh forest-plan consistency worksheet marks FW-STD-AR-01 not applicable for this
  project scope, so the current reviewer queue overstates component applicability.
...
### FOR-021-FW-STD-TBR-01

- Disposition: `evidence_linking_miss`
- Source type: `lacy_lemoosh_forest_plan_consistency_worksheet_replay`
- Rationale: The Lacy Lemoosh forest-plan consistency worksheet contains a non-not-applicable response for FW-
  STD-TBR-01; the current queue is missing or under-linking package evidence, not identifying a real
  EA omission.
